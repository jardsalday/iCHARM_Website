...
export const getPatients = ()=>(dispatch,getState)=>{
    axios.get('http://127.0.0.1:8000/api/getpatient/',tokenConfig(getState)).then(res=>{
...
export const searchPatient =name=>(dispatch,getState)=>{
    axios.get(`http://127.0.0.1:8000/api/searchweb/?name=${name}`,tokenConfig(getState)).then(res=>{
...
export const searchMedic =name=>(dispatch,getState)=>{
    axios.get(`http://127.0.0.1:8000/api/getmedic/?name=${name}`,tokenConfig(getState)).then(res=>{
        console.log(res.data)
...
export const addPatients = patrec =>(dispatch,getState)=>{
    ...
    axios.post('http://127.0.0.1:8000/api/registerpatient/',patrec,tokenConfig(getState) ).then(res=>{
...
export const addMedic = patrec =>(dispatch,getState)=>{
    ...
    axios.post('http://127.0.0.1:8000/api/registermedic/',patrec,tokenConfig(getState) ).then(res=>{
        const array1 = [res.data];
        console.log(array1);
        //const array1 = [{username:"this.state.username",password:"this.state.password2",patientprofile:{name:"Unique",birthdate:"More"}}];
...
export const getSpecPatient = patientID =>(dispatch,getState)=>{
    ...
    axios.get(`http://127.0.0.1:8000/api/getspecific/?id=${patientID}`,tokenConfig(getState) ).then(res=>{
        // const array1 = [res.data]    
        // //const array1 = [{username:"this.state.username",password:"this.state.password2",patientprofile:{name:"Unique",birthdate:"More"}}];
        // const test = array1.map(function(test1){return{user_id:test1.patientprofile.user_id,name: test1.patientprofile.name,
...
export const updatePatients = (patrec,id) =>(dispatch,getState)=>{
    ...
    axios.patch(`http://127.0.0.1:8000/api/getallpatient/${id}/`,patrec,tokenConfig(getState) ).then(res=>{
        // const array1 = [res.data]    
        // //const array1 = [{username:"this.state.username",password:"this.state.password2",patientprofile:{name:"Unique",birthdate:"More"}}];
        // const test = array1.map(function(test1){return{user_id:test1.patientprofile.user_id,name: test1.patientprofile.name,
        //     birthdate:test1.patientprofile.birthdate,sex:test1.patientprofile.sex,address:test1.patientprofile.address}})
...
export const getSpecMedic = patientID =>(dispatch,getState)=>{
    ...
    axios.get(`http://127.0.0.1:8000/api/getmedicspecific/?id=${patientID}`,tokenConfig(getState) ).then(res=>{
        // const array1 = [res.data]    
        // //const array1 = [{username:"this.state.username",password:"this.state.password2",patientprofile:{name:"Unique",birthdate:"More"}}];
        // const test = array1.map(function(test1){return{user_id:test1.patientprofile.user_id,name: test1.patientprofile.name,
        //     birthdate:test1.patientprofile.birthdate,sex:test1.patientprofile.sex,address:test1.patientprofile.address}})
...
export const updateMedics = (patrec,id) =>(dispatch,getState)=>{
    ...
    axios.patch(`http://127.0.0.1:8000/api/getallmedic/${id}/`,patrec,tokenConfig(getState) ).then(res=>{
        // const array1 = [res.data]    
        // //const array1 = [{username:"this.state.username",password:"this.state.password2",patientprofile:{name:"Unique",birthdate:"More"}}];
        // const test = array1.map(function(test1){return{user_id:test1.patientprofile.user_id,name: test1.patientprofile.name,
        //     birthdate:test1.patientprofile.birthdate,sex:test1.patientprofile.sex,address:test1.patientprofile.address}})
...
export const getUserMeasure = () =>(dispatch,getState)=>{
    ...
    axios.get('http://127.0.0.1:8000/api/measureuser/',tokenConfig(getState) ).then(res=>{
        // const array1 = [res.data]    
        // //const array1 = [{username:"this.state.username",password:"this.state.password2",patientprofile:{name:"Unique",birthdate:"More"}}];
        // const test = array1.map(function(test1){return{user_id:test1.patientprofile.user_id,name: test1.patientprofile.name,
        //     birthdate:test1.patientprofile.birthdate,sex:test1.patientprofile.sex,address:test1.patientprofile.address}})
...
export const updateRisk = (newRisk,id) =>(dispatch,getState)=>{
    ...
    axios.patch(`http://127.0.0.1:8000/api/measurement/${id}/`,newRisk,tokenConfig(getState) ).then(res=>{
        // const array1 = [res.data]    
        // //const array1 = [{username:"this.state.username",password:"this.state.password2",patientprofile:{name:"Unique",birthdate:"More"}}];
        // const test = array1.map(function(test1){return{user_id:test1.patientprofile.user_id,name: test1.patientprofile.name,
        //     birthdate:test1.patientprofile.birthdate,sex:test1.patientprofile.sex,address:test1.patientprofile.address}})
