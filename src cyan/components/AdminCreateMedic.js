...
export class AdminCreatePatient extends Component{
  ...
  componentDidMount(){
    ...
    axios.get('http://192.168.1.9:8000/api/getmedic/').then(res=>{const pseudo = res.data;
    console.log(pseudo);
    ...
    render(){   
        ...
        return (<div>
    <h6 className="header-form-text cyan-text "><span className="glyphicon glyphicon-download-alt"></span>{'   '}Add MEDIC</h6>
            <div className="Form ">
