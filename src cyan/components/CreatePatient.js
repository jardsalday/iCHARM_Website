...
getAge(bday){
    ...
    render(){
        ...
        return (<div>
    <h6 className="header-form-text cyan-text text-darken-1" style={{fontSize:"28px"}}><span className="glyphicon glyphicon-download-alt"></span>{'   '}Add Patient</h6>
            <div className="Form ">
        ...
        {this.state.errName?<h6 className="errsize red-text">Must not be blank or Name already exists</h6>:null}
                    ...
                    <br></br>
                    <div onClick={this.setMale.bind(this)} className={this.state.clickSex?"btn cyan  white-text":"btn black-text white"}>Male</div>
                    <div onClick={this.setFemale.bind(this)} className={this.state.clickSex?"btn white black-text":"btn cyan"}>Female</div>
                    
                    {this.state.errSex?<h6 className="errsize red-text">Must not be blank</h6>:null}
                    </div>
                    <div className="col s3"><label><h6>Diabetic?</h6></label>
                    <br></br>
                    <div onClick = {this.setDiaNo.bind(this)} className={this.state.clickDia?"btn cyan":"btn white black-text"}>No</div>
                   
                    <div onClick = {this.setDiaYes.bind(this)} className={this.state.clickDia?"btn white black-text":"btn cyan "}>Yes</div>
                     {this.state.errDia?<h6 className="errsize red-text">Must not be blank</h6>:null}
                    </div>
                    <div className="col s3"><label><h6>Smoker?</h6></label>
                    <br></br>
                    <div onClick = {this.setSmNo.bind(this)}  className={this.state.clickSmoke?"btn cyan":"btn white black-text"}>No</div>
                    <div onClick = {this.setSmYes.bind(this)}  className={this.state.clickSmoke?"btn black-text white":"btn cyan white-text"}>Yes</div>
                  {/* <div onClick = {this.setSmNo.bind(this)}  className={this.state.clickSmoke?"btn white black-text":"btn cyan"}>No</div> */}
                    {this.state.errDia?<h6 className="errsize red-text">Must not be blank</h6>:null}
                    </div>
                    </div>
                    <div className="row">
                   ...
                   <div className="col s6">
                    ...
                    <div className="col s4">
                    <label><h6 className="green-text">Username</h6></label>
                    ...
                    <button  class="btn btn-large cyan" type="submit" value="submit"> <span className="glyphicon glyphicon-saved"></span>Add  </button>
