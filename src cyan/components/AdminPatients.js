...
export class AdminPatients extends Component{
   ...
   searchName=e=>{
    ...
    if(search.length==0){
        ...
        axios.get(`http://127.0.0.1:8000/api/searchpatadmin/?name=${search}`).then(res=>{this.setState({all_patient:res.data})});
...
clearName=e=>{
    e.preventDefault();
    axios.get('http://127.0.0.1:8000/api/searchpatadmin/?name=12345').then(res=>{this.setState({all_patient:res.data})});
...
<li><a onClick={this.props.logout.bind(this)} href="/login" class="cyan-text"><span className="glyphicon glyphicon-log-out"></span> Logout</a></li>
          ...
          <div className="col-lg-5 col-md-6 col-sm-12 background2 "><AdminCreatePatient/></div>
                ...
                <div className="row">
                <div className="col-lg-5 col-md-6 col-sm-6 col-6"><h6 className="header-form-text cyan-text "><span className="glyphicon glyphicon-list"></span>Patient List</h6>
                </div>
