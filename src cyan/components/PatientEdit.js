            ...
            <div className="background grey lighten-4">
                ...
                <div class="navbar-fixed">
                            ...
                            <div class="container">
                                ...
                                <li><NavLink to ="/adminprofile"  className="cyan-text" ><span className=" cyan-text glyphicon glyphicon-home"></span>Home</NavLink></li>
             			<li> <Link to ="/adminpatients" className="btn cyan white-text text-darken-1" ><span className="glyphicon glyphicon-th-list"></span>Patients Records</Link></li>
                   ...
                   <li><NavLink to ="/adminprofile" className="cyan-text"  ><span className="cyan-text glyphicon glyphicon-user"></span> Profile</NavLink></li>
<li><a onClick={this.props.logout.bind(this)} href="/login" class="cyan-text"><span className="cyan-text glyphicon glyphicon-log-out"></span> Logout</a></li>
                                </ul>
                            </div>
                            </nav>
                        </div>
                ...
                <div class="navbar-fixed">
                            ...
                            <div class="container">
            			        ...
            			        <li> <Link to ={this.props.isAuthenticated?"/adminpatients":"/patient"} className="btn cyan white-text"><span className="glyphicon glyphicon-th-list"></span> Patient Records</Link></li>
                                <li><NavLink to ="/medicprofile" className="cyan-text"><span className="glyphicon glyphicon-user"></span> Profile</NavLink></li>
                ...
                <div  style={{position:"relative"}} className="col-lg-5  white edit-data">
                <div className="cyan lighten-2 center header-edit" style={{marginTop:"-28px",marginLeft:"-13.5px",width:"105%",backgroundColor:"linear-gradient(to left, #80deea  0%,#00bcd4   100%);"}}>
                ...
                value={this.state.editName?name:this.props.patientOne.map(data=>data.name)} */}
                 ...
                 :<input style={{color:"#4fc3f7",fontWeight:"bold"}} type ="text" name="birthdate" value={this.props.patientOne.map(data=> data.name)}>
                     </input>}
                    </div>
                ...
                {this.state.edit?<input type="text" name="birthdate" onChange={this.onChange} value={birthdate}></input>
                 :<input  style={{color:"#4fc3f7",fontWeight:"bold"}} type ="text" name="birthdate" value={this.props.patientOne.map(data=> data.birthdate)}></input>}   
                    </div>
                <div className = "col s6"><h5>Sex:</h5>
                {this.state.edit?<input type="text" name="sex" onChange={this.onChange} value={sex}></input>
                 :<input style={{color:"#4fc3f7",fontWeight:"bold"}} type ="text" name="sex" value={this.props.patientOne.map(data=> data.sex)}></input>}   
                ...
                value={this.state.editHeight?height:this.props.patientOne.map(data=>data.height)}></input> */}
                 ...
                 :<input style={{color:"#4fc3f7",fontWeight:"bold"}} type ="text" name="height" value={this.props.patientOne.map(data=> data.height)}></input>}   
                ...
                {this.state.edit?<input type="text" name="is_dia" onChange={this.onChange} value={is_dia}></input>
                 :<input style={{color:"#4fc3f7",fontWeight:"bold"}} type ="text" name="is_dia" value={this.props.patientOne.map(data=> data.is_dia)==3?    "YES":"NO"}></input>}    
                 </div>
                ...
                {/* <input type = "text" name="address" onChange = {this.onChange}
                 ...
                 :<input style={{color:"#4fc3f7",fontWeight:"bold"}} type ="text" name="address" value={this.props.patientOne.map(data=> data.address)}></input>}    
                     </div>
                ...
                {this.state.edit?<input type="text" name="email" onChange={this.onChange} value={email}></input>
                 :<input style={{color:"#4fc3f7",fontWeight:"bold"}} type ="text" name="email" value={this.props.patientOne.map(data=> data.email)}></input>}    
                </div>
                ...
                value={this.state.editPhone?phone_number:this.props.patientOne.map(data=>data.phone_number)}>
                 ...
                 :<input style={{color:"#4fc3f7",fontWeight:"bold"}} type ="text" name="phone_number" value={this.props.patientOne.map(data=> data.phone_number)}></input>}
