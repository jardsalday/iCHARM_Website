  ...
  onChange=e=> this.setState({[e.target.name]:e.target.value})
    render(){
     ...
     console.log(this.state.patientOne)
        return (
            <div className="background  grey lighten-4">
             ...
             <nav class="nav-wrapper white">
             			...
             			<li> <Link to ="/listusermeasure" className="cyan-text" ><span className="glyphicon glyphicon-th-list cyan-text"></span> Measures</Link></li>

                   <li><NavLink to ="/userpatient" className="btn cyan white-text" ><span className="glyphicon glyphicon-user white-text"></span> Profile</NavLink></li>
            			...
            			<li> <Link to ="/admin">Admin</Link></li>
                         ...
                         <div className={this.state.edit?"col-lg-5  userprofile2 card-panel white ":"col-lg-5 col-sm-5 userprofile2 card-panel white"}>
                           ...
                           <button className={this.state.edit?"editprofile btn green lighten-2 green-text right":"editprofile btn cyan green-text right"} onClick={this.state.edit?this.savePassword.bind(this):this.editData.bind(this)
        ...
        <h4 className="cyan-text text-darken-1">{this.props.patientOnes.map(data=>data.name)}</h4>
        <h6>Patient</h6>
                           ...
                           </div>  <div className={this.state.edit?"card-edit-pro":"card-pro"}><ul className={this.state.edit?"puserprofile green-text text-darken-1":" userprofile white-text text-darken-1"} style={this.state.edit?null:{paddingLeft:"20px",paddingTop:"20px"}}>
                             
        <li><h5><i className="glyphicon glyphicon-user white-text"></i> Username:<uu     className={this.state.edit?"cyan-text":"white-text"}>{this.props.user.username}</uu></h5></li> 
