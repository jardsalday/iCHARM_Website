        ...
        return (
            <div className=" background grey lighten-4">
                <div class="navbar-fixed">
             			...
             			<li> <Link to ="/adminpatients" className="cyan-text"><span className="glyphicon glyphicon-th-list"></span>Patients Records</Link></li>
                   <li> <Link to ="/adminmedics" className="btn cyan white-text text-darken-1" ><span className="glyphicon glyphicon-globe"></span>Medics Records</Link></li>
...
<li><a onClick={this.props.logout.bind(this)} href="/login" class="cyan-text"><span className="glyphicon glyphicon-log-out"></span> Logout</a></li>
                ...
                <div className="row">
                {/* <button className="btn cyan white-text add-medic" onClick={this.showHide.bind(this)}>{this.state.show?<span>HIDE FORM</span>:<span>ADD MEDIC</span>}</button> */}
                ...
                <div className="row">
                <div className="col-lg-8 col-md-6 col-sm-6 col-6"><h6 className="header-form-text cyan-text "><span className="glyphicon glyphicon-list"></span>MEDICS List</h6>
                </div>
