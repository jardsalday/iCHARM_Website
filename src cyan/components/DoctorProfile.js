 ...
 constructor(props){
  ...
  savePassword=e=>{
    ...
    if(password.length>0 && passwordsec.length>0 && password == passwordsec){
      ...
      axios.put(`http://127.0.0.1:8000/api/changepw?id=${user_id}`,patrec).then(res=>{console.log(res.data);alert("Password Changed");});
  ...
  componentDidMount(){
    ...
    //axios.get(`http://127.0.0.1:8000/api/getspecific/?id=${this.props.user.id}`).then(res=>this.setState({patientOne:res.data}));
            ...
            {this.props.isAdmin?
                ...
                <div class="navbar-fixed">
                            ...
                            <div class="container">
                                ...
                                <li><NavLink to ="/adminhome" className="cyan-text" ><span className=" cyan-text glyphicon glyphicon-home"></span>Home</NavLink></li>
                   ...
                   <li> <Link to ="/adminmedics" className="cyan-text"  ><span className="cyan-text glyphicon glyphicon-globe"></span>Medics Records</Link></li>
                   <li><NavLink to ="/medicprofile" className="btn cyan white-text text-darken-1" ><span className="glyphicon glyphicon-user"></span> Profile</NavLink></li>
<li><a onClick = {this.props.logout.bind(this)}href="/login" class="cyan-text"><span className="glyphicon glyphicon-log-out"></span> Logout</a></li>
                ...
                <div class="navbar-fixed">
                            ...
                            <div class="container">
            			        ...
            			        <li> <Link to ={this.props.isAuthenticated?"/adminpatients":"/patient"} className="cyan-text text-lighten-2"><span className="glyphicon glyphicon-th-list"></span> Patient Records</Link></li>
                                <li><NavLink to ="/medicprofile" className="btn cyan white-text"><span className="glyphicon glyphicon-user white-text "></span> Profile</NavLink></li>
                                <li><a onClick={this.props.logout.bind(this)} href="/login" class="cyan-text"><span className="glyphicon glyphicon-log-out"></span> Logout</a></li>
                                </ul>
                            </div>
                            </nav>
                        ...
                        <div className="col-lg-3 col-sm-4 col-md-4"></div>
                         ...
                         <button className={this.state.edit?"editprofile btn green lighten-2 white-text right":"editprofile btn cyan white-text right"} onClick={this.state.edit?this.savePassword.bind(this):this.editData.bind(this)
        ...
        <h4 className=" cyan-text text-darken-1" style={{textDecoration:"underline"}}>{this.props.medicOnes.map(data=>data.name)}</h4>
                          <h6>{this.props.medicOnes.map(data=>data.position)}</h6>
                           </div>
                           <div className="">
                           </div> 
                           <div className={this.state.edit?null:"card-pro"}>
                           <ul className={this.state.edit?"puserprofile grey-text text-darken-1":" userprofile white-text text-darken-1"} style={this.state.edit?null:{paddingLeft:"20px",paddingTop:"20px"}}>
                             
        <li><h5><i className="glyphicon glyphicon-user white-text"></i> Username:{'    '}<ba className={this.state.edit?"cyan-text text-lighten-1":"white-text text-darken-1"}>{this.props.user.username}</ba></h5></li> 
                           <li><h5><i className="	glyphicon glyphicon-envelope white-text"></i> Email:
                           <ba className="email-profile white-text text-darken-1">{'                                                  '}
                           {this.state.edit?<input type="text" className="input_edit_profile" style={{marginLeft:"95px",color:"#4dd0e1",width:"450px"}} name="email" onChange={this.onChange} value={email}></input>:this.props.medicOnes.map(data=>data.email)}</ba>
                           </h5></li>
                           <li><h5><i className="glyphicon glyphicon-earphone white-text"></i> Phone Number:<ba className="white-text text-darken-1">{'   '}{this.state.edit?<input type="text" name="phone_number" 
                            style={{marginLeft:"95px",color:"#4dd0e1",width:"455px"}} className="input_edit_profile" onChange={this.onChange} value={phone_number}></input>:this.props.medicOnes.map(data=>data.phone_number)}</ba></h5></li>
                          <li><h5><i className="glyphicon glyphicon-globe white-text"></i> Address:
                          <ba className="email-profile white-text text-darken-1">{'   '}{this.state.edit?<input type="text" style={{marginLeft:"95px",color:"#4dd0e1",width:"450px"}} name="address" className="input_edit_profile" onChange={this.onChange} value={address}></input>:this.props.medicOnes.map(data=>data.address)}</ba></h5></li>
                          ...
                          <u className="email-profile grey-tex">{'   '}{this.state.edit?<input type="password" style={{color:"#4dd0e1"}}  name="password" onChange={this.onChange} value={password}></input>:null}</u></h5></li><br/><br/>
                           </div>
                           <div className="col s6">
                          <li><h5>{this.state.edit?<h5>Retype Password</h5>:null}
                          <u className="email-profile grey-tex">{'   '}{this.state.edit?<input type="password" style={{color:"#4dd0e1"}}  name="passwordsec" onChange={this.onChange} value={passwordsec}></input>:null}</u></h5></li><br/><br/>
