      ...
      const { todos, currentPage, todosPerPage } = this.state;
        ...
        return (
            <div className="background  grey lighten-5">
             ...
             <nav class="nav-wrapper white lighten-3  " style={{borderBottom:"3px solid #00bcd4"}}>
                             <div class="container">
                                 <a href="#" class="brand-logo cyan-text">iCHARM Portal</a>
                                 <a href="#" class="sidenav-trigger" data-target="mobile-links">
                                 <i class="material-icons">menu</i>
                                 </a>
                                 <ul class="right hide-on-med-and-down">
                                 <li><NavLink to ="/patient" className="btn cyan white-text text-lighten-2" ><span className="glyphicon glyphicon-align-left"></span>Patient Records</NavLink></li>
              ...
              <span className="cyan-text text-lighten-1 pat_info	glyphicon glyphicon-user"></span><label className="cyan-text text-darken-2">Name:<test className="grey-text text-darken-2">{this.state.patientOne.map(data=>data.name)}</test></label>
              <span className="cyan-text text-lighten-1 pat_info		glyphicon glyphicon-calendar"></span><label className="cyan-text text-darken-2  ">Birthdate:<test className="grey-text text-darken-2">{this.state.patientOne.map(data=>data.birthdate)}</test></label>
              <span className="cyan-text text-lighten-1 pat_info	glyphicon glyphicon-time"></span><label></label ><i className="cyan-text text-darken-2 " >Age:<test className="grey-text text-darken-2">{this.state.patientOne.map(data=>data.age)}</test></i>
              <span className="cyan-text text-lighten-1 pat_info	fas fa-venus-mars"></span> <label></label><i className="cyan-text text-darken-2">Sex:<test className="grey-text text-darken-2">{this.state.patientOne.map(data=>data.sex)}</test></i>
              <span className="cyan-text text-lighten-1 pat_info 	glyphicon glyphicon-tint"></span><i className="cyan-text text-darken-2">Diabetic:<test className="grey-text text-darken-2">{main_diabetes==1?"NO":"YES"}</test></i>
              <span className="cyan-text text-lighten-1 pat_info 	glyphicon glyphicon-alert"></span><i className="cyan-text text-darken-2">Smoker:<test className="grey-text text-darken-2">{this.state.patientOne.map(data=>data.smoker)==1?"YES":"NO"}</test></i>
              <button onClick={this.getMeasurement.bind(this)}className="btn cyan right" style={{marginTop:"2px",paddingTop:"2px"}}><span className="	glyphicon glyphicon-refresh white-text"></span></button>
                         ...
                         <div className="row">
                            <div className="col-lg-2 new_measure_card  white" style={{}}>
               
        <div className="white lighten-1 " style={{paddingLeft:"10px",borderBottom:"2px solid lightgrey"}}>
        <label><h6 className="cyan-text text-darken-2" style={{fontSize:"20px"}}>BP:<test className="grey-text text-darken-3">{
        this.state.displaysys}/{this.state.displaydia}/hg</test></h6></label>
        </div>
                <Line option={{
                    responsive:false
                }}
                ...
                />
                           ...
                           <div className="col-lg-2 new_measure_card  white" style={{}}>
                <div className="white" style={{paddingLeft:"10px",borderBottom:"2px solid lightgrey"}}>          
                 <label><h6 className="cyan-text text-darken-2" style={{fontSize:"20px"}}>WEIGHT:<test className="grey-text text-darken-3">{this.state.displayweight}/kg</test> </h6></label>
                </div>
                <Line option={{
                    responsive:false
                }}
               ...
               <div className="white lighten-1 " style={{paddingLeft:"10px",borderBottom:"2px solid lightgrey"}}>
              <label><h6 className="cyan-text text-darken-2" style={{fontSize:"20px"}}>CHOLESTEROL:<test className="grey-text text-darken-3">{this.state.displaychol}/hg</test></h6></label>
               </div>
                <Line option={{
                    responsive:false
                }}
                ...
                />
                           ...
                           <div className="col-lg-4 new_measure_card_risk white" style={{borderBottom:"8px solid #00bcd4"}}  style={this.state.edit_risk?{height:"550px"}:null}>
               
       
                           {/* <div className="col-lg-4 row new_measure_card_risk  white"> */}
                           <div className={this.state.edit_risk?"col-lg-6":"graphshow"}>
                             <label for="risk_proba1"><span className="glyphicon glyphicon-exclamation-sign cyan-text text-lighten-1">HIGH RISK:</span> </label>
                             <input  onChange={this.onChange} type="text" name="risk_proba1" value={risk_proba1} placeholder="HIGH RISK PROBABILITY"/>
                            
                             </div>
                             
                             <div className={this.state.edit_risk?"col-lg-6":"graphshow"}>
                             <label for="risk_proba0"><span className="glyphicon glyphicon-exclamation-sign cyan-text text-lighten-1">LOW RISK:</span></label>
                             <input  onChange={this.onChange} type="text" name="risk_proba0" value={risk_proba0} placeholder="LOW RISK PROBABILITY"/>
                             
                             </div> <div className="white lighten-1  col-lg-12" style={{paddingLeft:"20px",borderBottom:"2px solid lightgrey"}}>
             {/* <div className="cyan lighten-1 col-lg-12" style = {{textAlign:"center"}}> */}
              <label><h6 className="cyan-text text-darken-3 " style={{fontSize:"20px"}}>RISK PROBABILITY:<test className="grey-text text-darken-3">HI={this.state.displayrisk1}%/LO={this.state.displayrisk0  }%</test></h6></label>
              <span className=" white lighten-3 right white-text" style={{marginTop:"5px"}} onClick={this.state.edit_risk?this.saveNewRisk.bind(this):()=>{this.setState({edit_risk:!this.state.edit_risk})}}> <span className="glyphicon glyphicon-pencil cyan-text text-lighten-2"></span></span>
             </div>
                <Line option={{
                    responsive:false
                }}
                ...
                />
                           ...
                           <div className="col-lg-6 new_list_card  " 
                            style={this.state.edit_risk?{marginTop:"-250px",borderBottom:"10px solid #00bcd4"}:{borderBottom:"10px solid #00bcd4"}}>
                             <table className="striped " >
                 
                <tr style={{borderTop:"10px solid #00bcd4"}}>
                    <th className="white lighten-1 grey-text text-darken-2"> Date</th>
                    <th className="white lighten-1 grey-text text-darken-2" >Systolic</th>
                    <th className="white lighten-1 grey-text text-darken-2">Diastolic</th>
                    <th className="white lighten-1 grey-text text-darken-2">Cholesterol</th>
                    <th className="white lighten-1 grey-text text-darken-2">Weight</th>
                    <th className="white lighten-1 grey-text text-darken-2">BMI</th>
                    <th className="white lighten-1 grey-text text-darken-2">LOW RISK</th>
                    <th className="white lighten-1 grey-text text-darken-2">HIGH RISK</th>
                    <th className= "white lighten-1 cyan-text text-darken-2">RISK</th>
                </tr>
                
       
                {currentTodos.map(data=>(<tr key={data.id}>
            <td className="white">{data.created_at}</td>
            <td className="white grey-text text-darken-1"><b>{data.systolic}</b></td>
            <td className="white grey-text text-darken-1"><b>{data.diastolic}</b></td>
            <td className="white grey-text text-darken-1"><b>{data.cholesterol}</b></td>
            <td className="white grey-text text-darken-1"><b>{data.weight}</b></td>
            <td  className="white grey-text text-darken-1"><b>{data.BMI}</b></td>
            <td className="white green-text text-lighten-3"><b>{data.risk_proba0}</b></td>
            <td className="white red-text text-lighten-1"><b>{data.risk_proba1}</b></td>
        <td className="white cyan-text tex-lighten-1"><b>{data.risk=='1'?"HIGH":"LOW"}</b></td>
